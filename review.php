...
<body>
			...
			<nav id="whiteBlock">
				...
				<ul class="nav nav-pills ">
					...
					<li class="nav-item active"><a class="nav-link"
						href="testamonials.php">Testamonials <span class="sr-only">(current)</span></a>
					</li>
    ...
    <div class="jumbo">
		...
		<div class="col-lg-12" id="whiteBlock">
			...
			<form name="myform" id="myform" action="review.php" method="post"
				...
				<div class="form-group">
					<label for="reviewby">Review by</label> <input class="form-control"
						id="reviewby" name="reviewby" required>
					</textarea>
				</div>
		...
		<nav>
			<ul class="nav nav-pills">
				...
				<li class="nav-item"><a class="nav-link active"
					href="testamonials.php">Testamonials</a></li>
...
if (isset($_POST['submit'])) {
    ...
    if ($stmt != 0) {
      ...
      $msg = "A new Review by " . $reviewby . "\n\nDate: " . $date . "\n\nReview:" . $review;
      $subject = "Wedding Review by: " . $reviewby;
